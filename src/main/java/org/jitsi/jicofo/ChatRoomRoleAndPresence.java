               ...
               AuthenticationListener
{
    ...
    {
    	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(chatRoom.getName());
        logger.info("Client : "+ clientName+ ": Chat room event " + evt);
            ...
            || ChatRoomMemberPresenceChangeEvent.MEMBER_QUIT.equals(eventType))
        {
            ...
            {
                logger.info("Client : "+clientName+" :Owner has left the room !");
                owner = null;
                electNewOwner();
            }
    ...
    private void electNewOwner()
    {
        ...
        if (focusRole == null)
        {
            ...
            logger.info("Client : "+ clientName +": Obtained focus role: " + userRole);
    ...
    private boolean verifyFocusRole()
    {
        ...
        {
        	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(chatRoom.getName());
            logger.error("Client : " +clientName+ ": Focus must be an owner!");
            conference.stop();
            return false;
        }
        return true;
