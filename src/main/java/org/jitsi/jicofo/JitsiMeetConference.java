               ...
               EventHandler
{
    ...
    private void joinTheRoom()
        throws Exception
    {
    	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
    	//String numberOfParticipants = clientAuthenticationImpl.getClientNameFromSessionMap().;
    	//String clientName = clientAuthenticationImpl.getClientNameFromSessionMap(getRoomName());
        logger.info("Client : " + clientName + " : Joining the room: " + roomName);
    ...
    private void leaveTheRoom()
    {
        ...
        {
        	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
            logger.error("Client : " + clientName + ": Chat room already left!");
            return;
        }
                                  ...
                                  final ColibriConference    colibriConference)
    {
        ...
        String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
        logger.info("Client : " + clientName +": Added participant for: " + address);
    ...
    public void destroy(String reason)
    {
        ...
        {
        	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
            logger.error("Client : "+ clientName +": Unable to destroy conference MUC room: " + roomName);
            return;
        }
    ...
    protected void onMemberLeft(ChatRoomMember chatRoomMember)
    {
        ...
        String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
        logger.info("Client : "+ clientName + ": Member " + contactAddress + " is leaving");
        ...
        if (leftPeer != null)
        {
            ...
            {
                logger.info("Client : "+ clientName +": Hanging up member " + contactAddress);
        ...
        {
            logger.error("Client : "+ clientName + ": Member not found for " + contactAddress);
        }
                                   ...
                                   Participant       participant)
    {
        ...
        {
        	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
            logger.info("Client : "+ clientName + ": Expiring channels for: " + participant.getMucJid());
    ...
    public void registrationStateChanged(RegistrationStateChangeEvent evt)
    {
        ...
        if (RegistrationState.REGISTERED.equals(evt.getNewState()))
        {
            ...
            if (chatRoom == null)
            {
                ...
                {
                	String clientName = clientAuthenticationAuthority.getClientNameFromSessionMap(getRoomName());
                    logger.error("Client : " + clientName + ": Failed to join the room: " + roomName, e);
