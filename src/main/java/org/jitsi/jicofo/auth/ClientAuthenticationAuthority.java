 ...
 */
public class ClientAuthenticationAuthority extends AbstractAuthAuthority implements AuthenticationAuthority {
	/**
	 * The logger.
	 */
	private final static Logger logger = Logger.getLogger(ClientAuthenticationAuthority.class);
